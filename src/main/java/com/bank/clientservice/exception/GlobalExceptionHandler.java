...
public class GlobalExceptionHandler {
    ...
    public Mono<ResponseEntity<OperationResponse>> handleDuplicateKeyException(DuplicateKeyException e) {
        log.error("Duplicate key exception occurred: {}", e.getMessage());
        return Mono.just(new ResponseEntity<>(new OperationResponse(
                ResponseMessage.DUPLICATE_KEY,
    ...
    public Mono<ResponseEntity<OperationResponse>> handeNotFoundException(NotFoundException e) {
        return Mono.just(new ResponseEntity<>(new OperationResponse(
                e.getMessage(),
